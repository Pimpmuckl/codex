...
const codexPackageName = packageJson.name;

const { platform, arch } = process;
const targetTriple = targetTripleForPlatform(platform, arch);
const platformPackage = platformPackageForTarget(packageJson, targetTriple);
...
function findCodexExecutable() {
  ...
  throw new Error(
    missingDependencyError(platformPackage, packageManager, codexPackageName),
  );
}
